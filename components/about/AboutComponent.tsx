...
export default function About() {
  return (
    <div className=" h-auto mb-10" id="about">
      <h2 className="text-green text-5xl md:text-8xl mt-40 font-bold">.about(<span className="text-white">&#123;&#125;</span>)</h2>
      <p className="text-white text-lg md:text-xl w-90 md:w-75ch pl-8 md:pl-15 mt-10 leading-relaxed">I am a Front-End Developer living in Oslo, Norway. I love to learn new things and figuring out how things work, and I often tend to get lost in my work.</p>
