...
export default function Home() {
  ...
  return (
    <div className="flex md:ml-0 flex-col h-95vh" id="home">
      <h1 className="text-green text-5xl md:text-8xl lg:text-9xl mt-32 md:mt-48 font-bold">.me(<span className="text-white">&#123;<span className="italic">Sander</span>&#125;</span>)</h1>
