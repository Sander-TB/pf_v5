...
export default function Blog() {
  ...
  return (
    <div className="h-auto mb-10" id="blog">
      <h2 className="font-sans mt-0 text-9xl md:text-20xl ml-8 md:ml-20 font-bold text-black-t-90">Blog</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-20 relative mt-10 md:mt-0 md:-top-44 ml-10 md:ml-12">
        {
          blogPosts.map((post) => (
            <div key={post.slug}>
              ...
              <p className="text-xl tracking-wide font-sans font-normal text-white mb-12 w-90 lg:w-50ch">{post.content}</p>
