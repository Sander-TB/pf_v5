...
export default function Portfolio() {
  ...
  return (
    <div className="flex flex-col">
      <h2 className="text-green sm:text-4xl text-5xl md:text-7xl lg:text-9xl mt-32 md:mt-48 mb-20 md:mb-44 font-bold">.portfolio(<span className="text-white">5</span>)</h2>
      <div className="flex flex-col">
        {
          pfData.map((project) => {
            return (
              <div key={project.id} className="flex flex-col md:flex-row mb-32">
                ...
                <div className="md:ml-20 md:w-1/2">
                  <h2 className="sm:text-3xl text-4xl lg:text-5xl font-bold text-orange mb-5 mt-10 lg:mt-0">{project.title}</h2>
