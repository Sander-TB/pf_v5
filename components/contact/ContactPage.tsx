...
export default function ContactPage() {
  return (
    <div className="h-auto mt-16 mb-20" id="contact">
      <h2 className="text-green text-6xl md:text-8xl mb-8 md:mb-16 font-bold">.contact(<span className="text-white">&#123;&#125;</span>)</h2>
