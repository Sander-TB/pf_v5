...
export default function ContactPage() {
  return (
    <div className="h-auto mt-16 md:mt-20 lg:mt-32 mb-20" id="contact">
      <h2 className="text-green text-5xl md:text-8xl lg:text-9xl mb-8 md:mb-16 font-bold">.contact(<span className="text-white">&#123;&#125;</span>)</h2>
